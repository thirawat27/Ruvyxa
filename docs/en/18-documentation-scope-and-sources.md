...
| Middleware/diagnostics | `crates/ruvyxa_middleware/src/*`, `crates/ruvyxa_diagnostics/src/lib.rs`                     | [Request pipeline](08-request-pipeline.md), [Security](13-security.md)                                                                    |
| Terminal presentation  | `crates/ruvyxa_tui/src/*`                                                                    | [CLI](10-cli.md), [Architecture](11-architecture.md)                                                                                      |
| Core surface           | `packages/@ruvyxa/core/src/{index,types,server,config,route-rules}.ts`                       | [Data](05-data-actions-api.md), [Configuration](07-configuration.md), [API reference](17-public-api-reference.md)                         |
...
| Demo examples          | `examples/demo/app/*`, `examples/demo/ruvyxa.config.ts`                                      | Chapters 03–09                                                                                                                            |
