...
บทนี้เป็นมุมมองเชิงงาน: จะหยิบ script ตัวไหน และมันทำอะไรกับโปรเจกต์ของคุณ **ตาราง flag
รายคำสั่งอยู่ใน [README](../../README.md#cli) ที่ root** ซึ่งเป็นที่รวมทุกคำสั่ง flag และกฎการ
normalize — หน้านี้ไม่เขียนซ้ำ และ `ruvyxa help <command>` จะพิมพ์ reference เดียวกันจาก binary
ที่คุณติดตั้งอยู่จริง

ภายใน Ruvyxa application ที่สร้างแล้ว ให้ใช้ npm script ตามตารางด้านล่าง นี่คือ interface ที่
