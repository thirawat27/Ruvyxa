...
| Route graph            | `crates/ruvyxa_graph/src/`                                                                   | [โครงสร้างโปรเจกต์](03-project-structure.md), [Routing](04-routing-rendering.md)                                                         |
...
| Middleware/diagnostic  | `crates/ruvyxa_middleware/src/*`, `crates/ruvyxa_diagnostics/src/lib.rs`                     | [Request pipeline](08-request-pipeline.md), [Security](13-security.md)                                                                   |
| Terminal presentation  | `crates/ruvyxa_tui/src/*`                                                                    | [CLI](10-cli.md), [Architecture](11-architecture.md)                                                                                     |
| Core surface           | `packages/@ruvyxa/core/src/{index,types,server,config,route-rules}.ts`                       | [ข้อมูล](05-data-actions-api.md), [Configuration](07-configuration.md), [API reference](17-public-api-reference.md)                      |
...
| Content engine         | `packages/ruvyxa/src/content-engine/index.ts`                                                | [Request pipeline](08-request-pipeline.md), [Observability](14-observability-performance.md)                                             |
...
| Demo example           | `examples/demo/app/*`, `examples/demo/ruvyxa.config.ts`                                      | บท 03–09                                                                                                                                 |

## Inventory ของ command ที่ตรวจแล้ว

| Scope                 | Command/script                                                                                                                                                                                                                                                                                                                                                                                               |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Ruvyxa CLI            | `dev`, `build`, `check`, `start`, `preview`, `routes`, `analyze`, `adds`, `doctor`, `clean`, `trace`, `bench`, `test:parity`                                                                                                                                                                                                                                                                                 |
| Generated application | `dev`, `build`, `start`, `preview`, `typecheck`, `check`, `routes`, `routes:json`, `analyze`, `analyze:html`, `adds`, `doctor`, `clean`, `trace`, `bench`, `test:parity`                                                                                                                                                                                                                                     |
...
[Data, action และ API route](05-data-actions-api.md)
