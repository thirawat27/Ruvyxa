...
บรรทัดสุดท้ายคือข้อจำกัดที่รู้อยู่ของการตรวจ typed route ทุกแบบ สิ่งที่การตรวจนี้จับได้แน่นอน
คือความผิดพลาดที่พบบ่อยกว่ามาก: ส่วน static ของ path ที่ผิด
