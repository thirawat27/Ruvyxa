// GENERATED by scripts/sync-shared-runtime.mjs from @ruvyxa/core/origin-policy.
// Do not edit: edit packages/@ruvyxa/core/src/origin-policy.ts instead, then run
...
export function fetchSiteIsCrossSite(headers) {
 ...
 */
export function parseForwardedScheme(value) {
 ...
 */
export function originIsCrossSite(headers, host, options = {}) {
    const origin = headers.get('origin');
    if (typeof origin !== 'string' || origin === '') {
        const site = headers.get('sec-fetch-site');
        return !(typeof site === 'string' && site.toLowerCase() === 'same-origin');
    }
    if (options.allowOrigins?.has(origin.toLowerCase()))
        return false;
