...
Prebuilt Ruvyxa native CLI binary for macOS x64.
...
The main `ruvyxa` package tries this optional package on macOS x64 after checking for a bundled native binary. The executable exposed by this package is `ruvyxa`.
