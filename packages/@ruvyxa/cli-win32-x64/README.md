...
Prebuilt Ruvyxa native CLI binary for Windows x64.
...
The main `ruvyxa` package tries this optional package on Windows x64 after checking for a bundled native binary. The executable exposed by this package is `ruvyxa.exe`.
