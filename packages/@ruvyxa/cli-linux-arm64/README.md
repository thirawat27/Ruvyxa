...
The main `ruvyxa` package tries this optional package on Linux arm64 after checking for a bundled native binary. The executable exposed by this package is `ruvyxa`.
